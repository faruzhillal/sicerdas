  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative pt-20 pb-32 lg:pt-32 lg:pb-52 overflow-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-indigo-50 border border-indigo-100 text-indigo-700 text-xs font-bold uppercase tracking-wider mb-8">
                <ShieldCheck size={14} />
                Portal Resmi Siswa
              </div>
              <h1 className="text-5xl lg:text-7xl font-extrabold text-slate-900 leading-[1.1] tracking-tight mb-8">
                Membangun Generasi <br />
                <span className="text-indigo-600">Cerdas & Berprestasi</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/ranking"
                  className="px-8 py-4 bg-indigo-600 text-white rounded-xl font-bold text-base hover:bg-indigo-700 hover:-translate-y-0.5 transition-all shadow-lg shadow-indigo-100 flex items-center gap-2"
                >
                  Lihat Pemeringkatan
                  <ArrowRight size={18} />
                </Link>
                <Link
                  to="/scholarships"
                  className="px-8 py-4 bg-white text-slate-900 border border-slate-200 rounded-xl font-bold text-base hover:bg-slate-50 transition-all shadow-sm"
                >
                  Program Beasiswa
                </Link>
              </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {stats.map((stat, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white p-6 sm:p-8 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center text-center group hover:border-indigo-200 transition-colors"
              >
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-20">
            <h2 className="text-sm font-bold text-indigo-600 uppercase tracking-[0.2em] mb-4">Layanan Unggulan</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <Link to="/login" className="inline-flex items-center gap-2 text-sm font-bold text-indigo-600 hover:gap-3 transition-all">
      ...
      <section className="py-24 px-4">
        <div className="max-w-7xl mx-auto rounded-[3rem] bg-indigo-600 p-8 sm:p-16 lg:p-24 relative overflow-hidden shadow-2xl">
          <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 blur-[100px] rounded-full -translate-y-1/2 translate-x-1/2" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-blue-400/20 blur-[100px] rounded-full translate-y-1/2 -translate-x-1/2" />
          ...
          <div className="relative z-10 max-w-2xl text-center mx-auto">
            ...
            <div className="mb-12">
              <p className="text-indigo-100 text-lg mb-2">Mari bergabung dan pantau prestasimu sekarang.</p>
            </div>
            <Link
              to="/login"
              className="inline-block px-10 py-5 bg-white text-indigo-600 rounded-2xl font-extrabold text-xl hover:bg-indigo-50 hover:scale-105 transition-all shadow-xl"
            >
